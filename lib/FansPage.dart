...
class FansPage extends StatefulWidget {
  ...
  @override
  _FansPage createState() => _FansPage();
...
class _FansPage extends State<FansPage> {
  ...
  _init()async{
    ...
    String? result = (await DioManager().requestAsync(
        NWMethod.GET, NWApi.fansRecords, {"data": jsonEncode(parm)}));
    // print(result);
    if (result != null) {
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: const [
                    ...
                    Text('互关',style: TextStyle(color: Colors.white,fontSize: 15),),
                  ],
                ),
              ),
            ) :
            InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: const [
                    Icon(Icons.compare_arrows,size: 24,color: Colors.white,),
                    Text('互关',style: TextStyle(color: Colors.white,fontSize: 15),),
                  ],
                ),
              ),
