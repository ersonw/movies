...
class UploadOss {
  ...
  static String url = 'https://$bucket.oss-cn-hongkong.aliyuncs.com';
  ...
  static Future<String?> upload({ required File file , String rootDir = 'moment', String? fileType, Function? callback, Function? onSendProgress}) async {
    ...
    String pathName = '$rootDir/${getDate()}/${getRandom(12)}.${fileType ?? getFileType(file.path)}';
