...
class BuyGoldRecordsPage extends StatefulWidget {
  const BuyGoldRecordsPage({Key? key}) : super(key: key);

  @override
  _BuyGoldRecordsPage createState() => _BuyGoldRecordsPage();
}

class _BuyGoldRecordsPage extends State<BuyGoldRecordsPage> {
  ...
  _init() async {
    ...
    String? result = (await DioManager().requestAsync(
        NWMethod.GET, NWApi.getGoldOrder, {"data": jsonEncode(parm)}));
    if (result != null) {
      // print(result);
  ...
  _cancelOrder(int id) async{
    ...
    String? result = (await DioManager().requestAsync(
        NWMethod.GET, NWApi.cancelGoldOrder, {"data": jsonEncode(parm)}));
    if (result != null) {
