...
class DiamondVideoPage extends StatefulWidget {
  const DiamondVideoPage({Key? key}) : super(key: key);

  @override
  _DiamondVideoPage createState() => _DiamondVideoPage();

}
class _DiamondVideoPage extends State<DiamondVideoPage> {
  ...
  _initLists() async{
    ...
    String? result = (await DioManager().requestAsync(
        NWMethod.GET, NWApi.diamondVideoLists, {"data": jsonEncode(parm)}));
    // print(result);
    if (result != null) {
